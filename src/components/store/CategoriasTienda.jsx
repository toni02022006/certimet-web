...
const categoriasBase = [
  { id: 2, name: 'Automatización y Control', img: cat1 },
  { id: 3, name: 'Analítica', img: cat2 },
  { id: 4, name: 'Variables de Procesos', img: cat3 },
  { id: 5, name: 'Laboratorio', img: cat4 },
  { id: 6, name: 'SSOMA', img: cat5 },
  { id: 7, name: 'Calidad de ambiente', img: cat6 },
];
